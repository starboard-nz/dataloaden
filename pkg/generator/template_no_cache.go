...
var tplNoCache = template.Must(template.New("generated").
	Funcs(template.FuncMap{
		"lcFirst": lcFirst,
	}).
	Parse(`
// Code generated by github.com/starboard-nz/dataloaden, DO NOT EDIT.
...
// Prime is noop, kept for compatibility with the caching version of the data loader
func (l *{{.Name}}) Prime(key {{.KeyType}}, value {{.ValType.String}}) bool {
	return false
}

// Clear is noop, kept for compatibility with the caching version of the data loader
